...
Adds a Copy button to Google Images. One click copies the full-resolution image to your clipboard. GIFs keep their animation.
...
When you click on an image in Google Images, a preview opens on the right. This extension adds a Copy button to that preview — click it and the original image is on your clipboard, ready to paste:
    ...
    Animated GIFs → copied with animation preserved (see the note below), or saved to Downloads
...
*** IMPORTANT NOTE ***
Animated GIF clipboard support requires a free helper script (macOS or Windows) — download it from the project homepage (linked below). One command to install, no admin rights needed.
